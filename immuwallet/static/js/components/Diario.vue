...
export default {
  ...
  computed: {
    mensagens() {
      return this.diario_manager ? this.diario_manager.mensagens : [];
    },
    ativo() {
      return this.diario_manager ? this.diario_manager.ativo : false;
    }
  },
  mounted() {
    this.diario_manager = new DiarioWS(this.solicitacao_id);
  },
  beforeDestroy(){
    this.diario_manager.destroy();
  },
  methods: {
    addMensagem() {
      ...
      var adicionou = this.diario_manager.addMensagem({
